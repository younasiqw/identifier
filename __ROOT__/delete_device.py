...
if form.getvalue('delete_device_id'):
   delete_device_id = form.getvalue('delete_device_id')
...
sql_delete_block = """ delete from devices where id = '%s' """%(delete_device_id)
...
try:
   ...
   if os.environ['REQUEST_URI'] != '/identification/__ROOT__/delete_device.py':
      print '''<script>
            alert('The device location was deleted');
           </script>
