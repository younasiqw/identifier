...
if  form.getvalue('ip_allow'):
    ip_allow = form.getvalue('ip_allow')
...
sql_allow = """ update administrator set ALLOW_IP_LIST=concat(ALLOW_IP_LIST, ' <br> %s') where id = 1 """ %(ip_allow)
